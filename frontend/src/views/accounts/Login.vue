<template>
    <div class="background">
        <div class="container p-3 mt-5 bg-light-ivory login-form">
            ...
            <p class="my-3"><span class="items" @click="clickSignup">회원가입하기</span>ㆍ<span class="items"
                                                                                         @click="clickPasswordFind">비밀번호 찾기</span>
            </p>
            <div class="buttons mt-3">
                <button class="btn login-button" :class="{disabled: !isSubmit}" @click="isSubmit && login(loginData)">
                    로그인하기
                </button>
            </div>
            ...
            <div class="buttons d-flex justify-content-center">
                <button class="btn kakao d-flex align-items-center justify-content-center" @click="kakaoLogin">
                ...
                window.Kakao.API.request({
                    ...
                    success: res => {
                        ...
                        if (userInfo.email === undefined) {
                            this.$router.push({name: 'Signup', params: {nickname: userInfo.nickname, platformType: userInfo.platformType}})
                        } else {
                            axios.post( SERVER.URL + SERVER.ROUTES.signupKakao, userInfo)
                            .then(res => {
                                console.log(res)
                                alert("로그인 성공!")
                                this.$router.push('/')
